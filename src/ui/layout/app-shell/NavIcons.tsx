export function PostsIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
      <path d="M4 19.5V5.7c0-.82 0-1.23.2-1.54a1.2 1.2 0 0 1 .46-.43c.33-.18.74-.18 1.56-.18h11.56c.82 0 1.23 0 1.56.18.2.1.36.25.46.43.2.3.2.72.2 1.54v13.8l-3-1.5-2.5 1.5-2.5-1.5-2.5 1.5-3-1.5Z" />
    </svg>
  );
}
...
export function SunIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
